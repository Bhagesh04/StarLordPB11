...
//
    ...
    private void showLanguageDialog() {
        ...
        TextView tvPunjabi = dialogView.findViewById(R.id.tvPunjabi);
        ...
        if (selectedLanguage.equals("mr")) {
            ...
            tvPunjabi.setBackgroundColor(getResources().getColor(R.color.purple_500));
            tvPunjabi.setTextColor(Color.WHITE);
        } else {
            tvEnglish.setBackgroundColor(getResources().getColor(R.color.purple_500));
            tvEnglish.setTextColor(Color.WHITE);
            tvPunjabi.setBackgroundColor(Color.TRANSPARENT);
            tvPunjabi.setTextColor(Color.BLACK);
        }
